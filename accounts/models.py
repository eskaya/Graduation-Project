...
class Mezun(models.Model):
    ...
    telefonNumarasi = models.CharField(max_length=120, null=True, blank=True)
    ...
    mezuniyetYili = models.DateField(null=True, blank=True)
    mezuniyetOrtalamasi = models.FloatField(null=True, blank=True)
...
class Ogrenci(models.Model):
    ...
    ogrenciNo = models.IntegerField(null=True, blank=True)
